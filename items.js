...
const ITEMS=[
  ...
  {id:"bamboo_spear",name:"青竹枪",type:"武器",rarity:"良品",desc:"竹径所出，轻而韧。",atk:7,price:55,stack:1},
  ...
  {id:"monk_robe",name:"无相僧衣",type:"防具",rarity:"精品",desc:"无相寺外门僧衣，略增定力。",def:10,wit:1,price:140,stack:1},
  /* 饰品 */
  ...
  {id:"blood_talisman",name:"血符",type:"饰品",rarity:"精品",desc:"血谷遗物，增臂力却伤神。",arm:2,price:180,stack:1},
  /* 消耗品 */
...
const DROP_TABLE={
  ...
  bamboo:[{id:"herb_stop",w:4},{id:"jinchuang",w:2},{id:"note_fist",w:1},{id:"bamboo_spear",w:1}],
  ...
  salt_road:[{id:"iron_blade",w:1},{id:"beast_bone",w:3},{id:"jinchuang",w:2},{id:"night_dagger",w:1}],
  mist_gate:[{id:"qingxin_dan",w:2},{id:"note_sword",w:2},{id:"qingfeng_sword",w:1}],
  hearth:[{id:"iron_ore",w:3},{id:"iron_blade",w:1},{id:"chilu_dao",w:1}],
  ...
  sparrow_den:[{id:"silk_thread",w:2},{id:"secret_letter",w:1},{id:"night_dagger",w:1}],
  void_temple:[{id:"qingxin_dan",w:2},{id:"void_bead",w:1},{id:"monk_robe",w:1}],
  cloud_peak:[{id:"jade_pendant",w:1},{id:"luck_bead",w:1},{id:"note_neigong",w:1}],
  blood_ravine:[{id:"iron_blade",w:2},{id:"beast_bone",w:2},{id:"blood_talisman",w:1}],
  secret_reef:[{id:"tide_pearl",w:3},{id:"jade_pendant",w:1},{id:"big_heal",w:1}],
  secret_cave:[{id:"silk_thread",w:2},{id:"note_sword",w:1},{id:"qiankun_bag",w:1}]
};
const SHOP_STOCK={
  qinghe:["jinchuang","wood_sword","cloth_robe","gift_tea"],
  market:["jinchuang","qingxin_dan","iron_blade","leather_armor","copper_ring","gift_wine","note_fist","qiankun_bag"],
  herb_valley:["huichun_san","qingxin_dan","herb_stop","spirit_herb"],
  whale_port:["tide_pearl","gift_wine"],
  hearth:["iron_ore","iron_blade"],
  mist_gate:["qingfeng_sword","jade_pendant"],
  void_temple:["qingxin_dan","monk_robe"]
};
...
(function patchItemSystems(){
  ...
  if(typeof calcCombatPower==="function"){
    ...
    calcCombatPower=function(player){
      ...
      var b=getEquipBonuses(player);
      return base+Math.floor((b.atk||0)*2+(b.def||0)*1.5+(b.luck||0)*3+(b.wit||0));
    };
  }
